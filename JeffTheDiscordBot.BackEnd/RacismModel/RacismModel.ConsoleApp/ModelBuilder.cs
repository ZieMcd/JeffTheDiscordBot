...
using RacismModel.Model;

namespace RacismModel.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Admin\CodeProjects\JeffTheDiscordBot\JeffTheDiscordBot.BackEnd\TweetBLM.csv";
